...
Now you can reach the backend and connect to websocket at *webchat-mscarceller.cloud.okteto.net/chat*
...
Then you can deploy it in the same way as you do on you local Kubernetes
